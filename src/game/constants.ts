...
export const BALL_ATTACHED_OFFSET_X = 59
export const BALL_ATTACHED_OFFSET_Y = BALL_RADIUS - 3
...
export const GOAL_NET_REACTION_TIME = 0.45
export const BLOCKED_FEEDBACK_TIME = 0.42
